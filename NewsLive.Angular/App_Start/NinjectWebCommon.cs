[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(NewsLive.Angular.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(NewsLive.Angular.App_Start.NinjectWebCommon), "Stop")]
...
namespace NewsLive.Angular.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IArticleLikeRepository>().To<ArticleLikeRepository>();
